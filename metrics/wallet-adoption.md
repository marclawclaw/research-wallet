...
| Trust Wallet | wallet-core: 3,553; assets: 5,361; trust-web3-provider: 915 (no single main repo — app is closed source) | **17M+ MAU** (coinlaw.io, early 2025, third-party; not a Trust Wallet primary disclosure) / **60M "users"** (per coinlaw.io, original source cited as sqmagazine.co.uk — not independently confirmed; early 2025 — likely cumulative accounts, not MAU; not independently archived; distinction from 17M MAU unresolved) | 200M+ total (self-reported, trustwallet.com homepage and Google Play, August 2026); Google Play install tier: 50M+; Google Play rating: 4.48/5 (2.54M reviews) | 2026-08-12 |
...
- Trust Wallet (updated 2026-08-12): 17M+ MAU per [coinlaw.io/trust-wallet-statistics/](https://coinlaw.io/trust-wallet-statistics/) — accessed 2026-08-12 — [archived](../sources/2026-08-12-coinlaw-io-trust-wallet-statistics.html); 60M "users" figure per coinlaw.io (original source cited as sqmagazine.co.uk — not independently confirmed) — URL not archived; 200M+ total users self-reported per [trustwallet.com](https://trustwallet.com) — accessed 2026-08-12 — [archived](../sources/2026-08-12-trustwallet-com-home.html) and [Google Play structured JSON-LD](https://play.google.com/store/apps/details?id=com.wallet.crypto.trustapp) — accessed 2026-08-12 — [archived](../sources/2026-08-12-play-google-com-trust-wallet.html); 50M+ Play install tier from same Play page; wallet-core stars per [GitHub API](https://api.github.com/repos/trustwallet/wallet-core) — [archived](../sources/2026-08-12-api-github-com-trustwallet-wallet-core.json); assets stars per [GitHub API](https://api.github.com/repos/trustwallet/assets) — [archived](../sources/2026-08-12-api-github-com-trustwallet-assets.json); conflicting MAU figures both recorded; neither is a primary Trust Wallet audited disclosure
