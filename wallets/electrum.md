...
- **Lightning:** Built-in Lightning Network using trampoline routing. ACINQ (`node.acinq.co`) is the sole hardcoded mainnet trampoline node. Features: open/close channels from on-chain balance; send/receive LN payments; LNURL (LUD-16 lightning address support added in v4.5.0, January 2024 — RELEASE-NOTES — [archived](../sources/2026-08-10-github-com-spesmilo-electrum-RELEASE-NOTES.txt); LUD-17 payment identifiers added in v4.8.0, July 2026 — RELEASE-NOTES #10575 — [archived](../sources/2026-08-10-github-com-spesmilo-electrum-RELEASE-NOTES.txt)); Nostr Wallet Connect (NWC) plugin; submarine swaps (on-chain ↔ Lightning); reverse swaps to external addresses (added in v4.7.0, January 2026 — RELEASE-NOTES #10303 — [archived](../sources/2026-08-10-github-com-spesmilo-electrum-RELEASE-NOTES.txt)); watchtower support (self-host or third-party). Anchor outputs required for newly opened channels (since v4.8.0). LN forwarding is explicitly experimental and warned against in mainnet (v4.8.1). Multi-path payments (MPP) supported.
